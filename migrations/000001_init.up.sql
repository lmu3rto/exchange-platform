...
CREATE INDEX IF NOT EXISTS idx_tasks_published ON tasks (created_at) WHERE status = 'published';
CREATE INDEX IF NOT EXISTS idx_tasks_cr_id ON tasks (customer_id, status);
CREATE INDEX IF NOT EXISTS idx_tasks_er_id ON tasks (executor_id, status);
